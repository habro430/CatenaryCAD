...
namespace CatenaryCAD
{
    public sealed class Main : Multicad.Runtime.IExtensionApplication
    {
        ...
        /// Загруженные сборки
        /// </summary>
        public static Assembly[] CatenaryAssemblies { private set; get; }

        /// <summary>
        /// Загружает производные от IModel объекты из плагинов *.dll раположенных в <paramref name="directory"/>
        /// </summary>
