...
namespace CatenaryCAD.Models
{
    public interface IMast : IModel
    {
        ...
        /// все непосредственно наследуемые от абстрактного класса модели фундамента. 
        /// При наличии класса определенной модели фундамента, то допустимым фундаментом 
        /// являеться только указанная модель (т.е. наследуемые модели не учитываются) 
        /// </remarks>
        /// <value>По умолчанию возвращает все фундаменты, наследуемые от <seealso cref="Foundation"/></value>
        Type[] Foundations { get; }

        /// <summary>
        /// Возвращяет точку присоединения арматуры к стойке на плане
        /// </summary>
        /// <param name="ray">Луч для определения пересечения</param>
        /// <returns>Если луч и геометрия на схеме пересекаются, то возвращает <seealso cref="Point2D"/> 
        /// в месте пересечения, в противном случае возвращает null</returns>
        Point2D? GetPointForDockingJoint(Ray2D ray);

        /// <summary>
        /// Возвращяет точку присоединения арматуры к стойке на макете
        /// </summary>
        /// <param name="ray">Луч для определения пересечения</param>
